            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Only receive notifications for candidates that meet or exceed this rating. Candidates 3-5 stars should meet all job requirements and are likely a good fit for the role
                  </FormDescription>
                </FormItem>
              )}
            />
