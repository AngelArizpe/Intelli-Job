                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      value={field.value ?? ""}
                      className="min-h-32"
                      placeholder="Describe the jobs you're interested in. For example: 'I'm looking for remote frontend development positions that use React and pay at least 400,000 MXN per year'"
                    />
                  </FormControl>
                  <FormDescription>
