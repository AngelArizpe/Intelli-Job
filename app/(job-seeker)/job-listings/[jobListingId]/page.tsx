...
import { JobListingItems } from "../../shared/JobListingItems";
...
import { getJobListingApplciationIdTag } from "@/features/jobListingApplications/db/cache/jobListingApplications";
  ...
  if (application != null) {
    ...
    return (
        <div className="text-muted-foreground text-sm">
            You applied for this job {difference === 0 ? "today" : formatter.format(difference, "days")}
        </div>
    )
  }
    ...
    <Dialog>
      ...
      <DialogContent className="md:max-w-3xl max-h[calc(100%-2rem)] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Applying for a job cannot be undone and is something you can do once per job listing.
          </DialogDescription>
        </DialogHeader>
...
async function getJobListingApplication({
    ...
    "use cache"
    cacheTag(getJobListingApplciationIdTag({ jobListingId, userId }))
